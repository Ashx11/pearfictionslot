...
export function winTheme(total) {
  if (total <= 0) return { outline: 0x000000, pulse: 0x000000, panel: 0x000000, panelA: 0.0, line: 0x000000 };
  if (total >= 20) return { outline: 0xf5c542, pulse: 0xf5c542, panel: 0xf5c542, panelA: 0.16, line: 0xe2b339 }; // jackpot gold
  if (total >= 10) return { outline: 0x38bdf8, pulse: 0x38bdf8, panel: 0x38bdf8, panelA: 0.14, line: 0x22a7e6 }; // medium win cyan
