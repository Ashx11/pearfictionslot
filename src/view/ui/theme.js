...
export function panelThemeForState(state) {
  switch (state) {
    case 'ready': // pale yellow
      return { panel: 0xfef3c7, panelA: 0.95 }; // amber-100
    case 'loss': // soft red
      return { panel: 0xfee2e2, panelA: 0.95 }; // rose-100
    case 'win': // soft green
      return { panel: 0xdcfce7, panelA: 0.95 }; // green-100
    case 'jackpot': // soft gold
      return { panel: 0xfaf3d7, panelA: 0.95 }; // warm gold-ish
